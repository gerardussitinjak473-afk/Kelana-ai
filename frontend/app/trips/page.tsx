  ...
  return (
    <main className="min-h-screen bg-sand">
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 sm:px-8 lg:px-12 lg:py-16">
          ...
          <div className="grid w-full gap-3 sm:grid-cols-[minmax(0,1fr)_220px] lg:max-w-2xl">
            <label className="relative block">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[#ded8cc] bg-white py-3.5 pl-12 pr-4 text-sm font-semibold outline-none transition focus:border-lagoon focus:ring-4 focus:ring-lagoon/10"
              />
            </label>
            <label>
              ...
              <select
                ...
                className="w-full rounded-2xl border border-[#ded8cc] bg-white px-4 py-3.5 text-sm font-semibold text-ink outline-none transition focus:border-lagoon focus:ring-4 focus:ring-lagoon/10"
              >
        ...
        {loading ? (
          <div className="mt-10 grid min-h-80 place-items-center rounded-[2rem] border border-[#ded8cc] bg-white">
          ...
          <div className="mt-10 grid min-h-96 place-items-center rounded-[2rem] bg-gradient-to-br from-pine to-lagoon p-8 text-center text-white shadow-float">
            <div>
              <MapIcon className="mx-auto h-14 w-14 text-teal-200" />
              ...
              <Link href="/#rencanakan" className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-extrabold text-pine hover:bg-teal-50">
                <PlusIcon className="h-4 w-4" /> Rencanakan perjalanan
              </Link>
            </div>
          </div>
        ) : filteredTrips.length === 0 ? (
          <div className="mt-10 grid min-h-72 place-items-center rounded-[2rem] border border-[#ded8cc] bg-white p-8 text-center">
            <div>
          ...
          <>
            ...
            {filteredTrips.length > ITEMS_PER_PAGE && (
              <nav className="mt-8 flex flex-col items-center justify-between gap-4 rounded-2xl border border-[#ded8cc] bg-white px-5 py-4 sm:flex-row" aria-label="Paginasi perjalanan">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="grid h-10 w-10 place-items-center rounded-full border border-teal-100 text-pine transition hover:border-lagoon hover:bg-teal-50 disabled:cursor-not-allowed disabled:opacity-35"
