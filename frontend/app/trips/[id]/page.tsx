          ...
          <>
            <div className="overflow-hidden rounded-[2rem] bg-ink text-white shadow-float">
              <div className="grid gap-8 p-7 sm:p-10 md:grid-cols-[auto_1fr] md:items-center">
                ...
                <div>
                  <p className="flex items-center gap-2 text-xs font-extrabold uppercase tracking-[0.2em] text-teal-300"><MapPinIcon className="h-4 w-4" /> Detail perjalanan</p>
            ...
            <article className="mt-6 overflow-hidden rounded-[2rem] border border-[#ded8cc] bg-white">
              <div className="flex items-center gap-3 border-b border-[#ded8cc] px-6 py-5 sm:px-8">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-teal-50 text-lagoon"><SparklesIcon className="h-5 w-5" /></span>
                <div>
